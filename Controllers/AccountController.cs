...
namespace Blog.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<IActionResult> Post([FromBody] RegisterViewModel model,[FromServices] EmailServices emailServices, [FromServices] BlogDataContext context)
        {
            ...
            try
            {
                ...
                emailServices.Send(user.Name, user.Email, "Bem vindo", password);
        ...
        public async Task<IActionResult> UploadImage([FromBody] UploadImageViewModel model, [FromServices]BlogDataContext context)
        {
            ...
            user.Image = $"httpts://localhost:0000/images/{fileName}";
            ...
            return Ok(new ResultViewModel<string>("Imagem alterada", null));
        }
    }
}